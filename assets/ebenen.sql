...
-- --------------------------------------------------------
--
-- Tabellenstruktur fÃ¼r Tabelle `hauptkategorien`
--
...
--
-- Daten fÃ¼r Tabelle `hauptkategorien`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `unterkategorien`
--
...
--
-- Daten fÃ¼r Tabelle `unterkategorien`
--
...
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
(10300000, 'ZubehÃ¶r', '2CDE',10000000);
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
...
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
(20600000, 'SchlÃ¼ssel', '5AB',20000000);
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
(20700000, 'Akkuschrauber', '3C',20000000);
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
(20800000, 'Bits/NÃ¼sse', '5AB',20000000);
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
(20900000, 'ZubehÃ¶r', '5AB',20000000);
INSERT INTO `unterkategorien` (`_id`, `untkbezeichnung`, `untkstandort`,`fk_hauptkategorien`) VALUES
...
-- --------------------------------------------------------
--
-- Tabellenstruktur fÃ¼r Tabelle `artikel`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `bestellkopf`
--
...
--
-- Daten fÃ¼r Tabelle `bestellkopf`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `bestellpositionen`
--
...
--
-- Daten fÃ¼r Tabelle `bestellpositionen`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `produktkategorien`
--
...
--
-- Daten fÃ¼r Tabelle `produktkategorien`
--
...
INSERT INTO `produktkategorien` (`_id`, `prodkbezeichnung`, `prodkstandort`,`fk_unterkategorien`) VALUES
(80201000, 'GlÃ¼hbirnen', '1 C',80200000);
INSERT INTO `produktkategorien` (`_id`, `prodkbezeichnung`, `prodkstandort`,`fk_unterkategorien`) VALUES
...
--
-- Tabellenstruktur fÃ¼r Tabelle `stammkunden`
--
...
--
-- Daten fÃ¼r Tabelle `stammkunden`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `stationen`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `tempkunden`
--
...
--
-- Tabellenstruktur fÃ¼r Tabelle `zusatzinformationen`
--
...
--
-- Daten fÃ¼r Tabelle `zusatzinformationen`
--
